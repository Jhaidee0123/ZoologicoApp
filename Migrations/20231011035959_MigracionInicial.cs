        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NecesidadesAseo = table.Column<string>(type: "TEXT", nullable: false),
                    NecesidadesAseoHabitat = table.Column<string>(type: "TEXT", nullable: false),
                    Peso = table.Column<double>(type: "REAL", nullable: true),
                    Vacunas = table.Column<string>(type: "TEXT", nullable: false),
                    Alimentacion = table.Column<string>(type: "TEXT", nullable: false),
                    Alergias = table.Column<string>(type: "TEXT", nullable: false),
                    Medicamentos = table.Column<string>(type: "TEXT", nullable: false),
                    OtrosDatos = table.Column<string>(type: "TEXT", nullable: false),
                    CuidadorId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CuidadorId1 = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Animales_AspNetUsers_CuidadorId1",
                        column: x => x.CuidadorId1,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NombreProfesional = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    AnimalId1 = table.Column<Guid>(type: "TEXT", nullable: false),
                    CreadoEn = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConsultasMedicas_Animales_AnimalId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamenesLaboratorio_Animales_AnimalId1",
                        column: x => x.AnimalId1,
                        principalTable: "Animales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsultasMedicas_AnimalId1",
                table: "ConsultasMedicas",
                column: "AnimalId1");

            migrationBuilder.CreateIndex(
                name: "IX_ExamenesLaboratorio_AnimalId1",
